...
You can download the compendium as a zip from from this URL: <https://github.com/nevrome/workingtitle/archive/master.zip>

Or you can install this compendium as an R package, workingtitle, from GitHub with:
