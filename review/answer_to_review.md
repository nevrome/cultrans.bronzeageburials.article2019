...
This is absolutely true and I tried to emphasise the limitations of the data in the discussion. The challenges are not confined on the amount of data, but also concern its meaning and origin. The supplementary remarks are extensively long to cover these problems. 
