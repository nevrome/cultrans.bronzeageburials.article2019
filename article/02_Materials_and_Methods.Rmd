...
colnames(dprcrosstab)[1:2] <- c("Region", "Burial type")
dprcrosstab %>% 
  dplyr::mutate_at(
    dplyr::vars(tidyselect::one_of("flat", "mound", "unknown")),
    list(~kableExtra::cell_spec(., "latex", bold = . > 100)) 
  ) %>%
  knitr::kable(
