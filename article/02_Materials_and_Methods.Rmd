...
To understand the results in Table \ref{tab:distanceandcorrelationtable*} we need a frame of reference: *How should the correlation coefficient develop if there was a strong correlation between spatial and cultural distance? How is the degree of cultural transmission related to correlation and similariy of cultural traits and therefore cultural distance?*
