...
Figure \ref{correlationtimeseries} shows the development of the correlation coefficient values obtained via Mantel statistics (Table \ref{tab:dacta} & \ref{tab:dactb}) during the succession of the seven relevant 200 years time slots.
