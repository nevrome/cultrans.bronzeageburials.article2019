...
7. Manually defining a rectangular (EPSG:102013) research area with sufficient information in Central-, Northern and Northwestern Europe based on perceived spatial date distribution (Figure \ref{map}).
...
knitr::kable(
  ...
  "latex", 
  caption = "\\label{distance_and_correlation_table}Demo table", 
  booktabs = T,
