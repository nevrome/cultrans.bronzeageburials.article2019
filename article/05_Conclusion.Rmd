...
Beyond these intrinsic results, it is important now to ask what it means for the study of human behaviour in general. Three possible answers:

1. For this paper burial traditions were the main object of research, but the same methodological approach could be applied for other aspects of cultural behaviour.
