...
The dataset used for the analysis in this paper is a subset of the openly available database Radon-B [@kneiselRadonB2013]. It contains ^14^C dates from the European Bronze and Early Iron Age (2300 BC to 500 BC). Radiocarbon dating is one of the major absolute dating techniques for this period [@ramseyRadiocarbonDatingRevolutions2008] and Radon-B is a collection of more than 11,000 published dates  from around 3,500 sites from all over europe.
